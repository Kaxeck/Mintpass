...
export const eventSchema = z.object({
  ...
  description: z.string().min(10, "La descripción del evento es requerida (al menos 10 caracteres)"),
  category: z.string().min(1, "Debes seleccionar una categoría"),
  ...
  zones: z.array(z.object({
    ...
    price: z.number().min(0, "El precio no puede ser negativo").refine(p => p === 0 || p >= 0.01, "El precio mínimo en Solana es de 0.01 SOL (o 0 para eventos gratuitos)"),
  ...
  doorTime: z.string().min(1, "La hora de apertura de puertas es requerida"),
